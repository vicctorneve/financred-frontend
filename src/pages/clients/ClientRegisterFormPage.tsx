  ...
  const { isLoading } = useQuery({
    ...
    queryFn: async () => {
      ...
      form.reset({
        ...
        dadosFinanceiros: {
          renda: data.dadosFinanceiros.renda,
          profissao: data.dadosFinanceiros.profissao,
          empresa: data.dadosFinanceiros.empresa || '',
          contaBancaria: data.dadosFinanceiros.contaBancaria ? {
            banco: data.dadosFinanceiros.contaBancaria.banco,
            agencia: data.dadosFinanceiros.contaBancaria.agencia,
            conta: data.dadosFinanceiros.contaBancaria.conta,
          } : undefined,
        },
      });
...
export default ClientRegisterFormPage;
